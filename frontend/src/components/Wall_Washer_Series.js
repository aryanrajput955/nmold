		...
		<>
			<div className='ml-6 mb-20 w-[800px]'>
				...
				<div className=''>
					<div>
						...
						<div className='flex flex-wrap mt-4 gap-10'>
							...
							<Link to='/lighting/Wall Washer 1'>
								<Lighting_products
									img_url='/product_images/wall_washer_1.png'
									text='Wall Washer 1'
								/>
							</Link>
							<Link to='/lighting/Wall Washer 2'>
								<Lighting_products
									img_url='/product_images/wall_washer_2.png'
									text='Wall Washer 2'
								/>
							</Link>
							<Link to='/lighting/Wall Washer 3'>
								<Lighting_products
									img_url='/product_images/wall_washer_3.png'
									text='Wall Washer 3'
								/>
							</Link>
						</div>
					...
					<div
						className={`transition-all ease-linear duration-300 flex gap-10 overflow-hidden flex-wrap mt-2 ${isWall ? 'h-[45rem]' : 'h-0'
							}`}>
						<Link to='/lighting/Wall Washer 4'>
							<Lighting_products
								img_url='/product_images/wall_washer_4.png'
								text='Wall Washer 4'
							/>
						</Link>
						<div>
							...
							<div className='flex flex-wrap mt-4 gap-10'>
								...
								<Link to='/lighting/Inground Wallwasher 1'>
									<Lighting_products
										img_url='/product_images/inground_wallwasher_lights.png'
										text='Inground Wall Washer 1'
									/>
								</Link>
								<Link to='/lighting/Inground Wallwasher 2'>
									<Lighting_products
										img_url='/product_images/inground_wallwasher_lights 2.png'
										text='Wall Washer 2'
									/>
								</Link>
								<Link to='/lighting/Inground Wallwasher 3'>
									<Lighting_products
										img_url='/product_images/inground_wallwasher_lights 3.png'
										text='Wall Washer 3'
									/>
								</Link>
							</div>
